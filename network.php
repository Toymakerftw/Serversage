    ...
    <div class="modal-content">
      ...
      <table style="  text-align: center  " class="table">
        ...
        <tbody>
          ...
          // read all row from database table
          $sql = "SELECT ip FROM currentiptable WHERE ip IN (SELECT ip FROM knowiptable);";
          $result = $connection->query($sql);
    ...
    <div class="modal-content">
      ...
      <table style="  text-align: center  " class="table">
        ...
        <tbody>
          ...
          // read all row from database table
          $sql = "SELECT ip FROM knowiptable WHERE ip NOT IN (SELECT ip FROM currentiptable);";
          $result = $connection->query($sql);
          ...
          while ($row = $result->fetch_assoc()) {
            echo "<tr> <td>";
            echo  $row["ip"];
            echo '<span style="color: red"> is Offline</span></p>';
            echo "</td></tr>";
          }
          $connection->close();
          ?>
